...
map.getView().fit([684454.590004, 9188014.257972, 702218.218604, 9199993.137779], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Kampus PTN di Surabaya</h2>';
        return titleElement;
    })(),
